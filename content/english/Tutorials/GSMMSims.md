...
{{< figure src="/images/Tutorials/GSMMSims/Metabolic_Metro_Map.png" caption="Visualization of metabolic pathways forming a metabolic network ([Chakazul, Wikimedia Commons](https://en.wikipedia.org/wiki/File:Metabolic_Metro_Map.svg))." numbered="true" width="800" position="center" command="fill" option="q100" class="img-fluid" webp="false" >}}
